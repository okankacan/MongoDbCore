...
using MongoDbExample.Business.Repository;
using MongoDbExample.Business.Repository.Interface;

namespace MongoDbExample.WebSite
{
    public class Startup
    {
        ...
        private void ConfigureScopedServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IUserRepository>(x => new UserRepository(mongoConnectionString, "MongoUsers", "Users"));
